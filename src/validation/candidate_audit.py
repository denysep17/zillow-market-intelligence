...
CANDIDATES = {
    "sale_to_list": {
        "url": (
            "https://files.zillowstatic.com/research/public_csvs/mean_sale_to_list/"
    ...
    "affordability_income_needed": {
        "url": (
            ...
            "Metro_new_homeowner_income_needed_downpayment_0.20_"
    ...
    for metric, spec in CANDIDATES.items():
        try:
            ...
            result = {
                ...
                "overlap_with_zhvi_rate": float(
                    len(overlap) / max(len(zhvi_keys), 1)
                ),
